...
public enum ErroCode {
    ...
    PAYMENT_ALREADY_PROCESSED(4002, "Giao dịch đã được xử lý"),
    PAYMENT_FAILED(4003, "Thanh toán thất bại"),
    PAYMENT_CANCELLED(4004, "Thanh toán đã bị hủy"),
    PAYMENT_INVALID_SIGNATURE(4005, "Chữ ký thanh toán không hợp lệ"),
    PAYMENT_CREATE_ERROR(4006, "Lỗi khi tạo thanh toán"),

    // Coupon errors (4100-4199)
    COUPON_NOT_FOUND(4101, "Mã giảm giá không tồn tại"),
