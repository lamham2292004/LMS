    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        // Payment endpoints (VNPay callback and Create (authenticated))
                        .requestMatchers("/api/payment/vnpay-return", "/api/payment/vnpay-ipn").permitAll()
                        // Note: /api/payment/create and /history remain authenticated by default
                ...
                .exceptionHandling(exceptions -> exceptions
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            response.getWriter()
                                    .write("{\"code\": 2001, \"message\": \"Vui lòng đăng nhập để tiếp tục\"}");
                        })
